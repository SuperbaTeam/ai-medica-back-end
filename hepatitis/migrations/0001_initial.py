    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('steriod', models.CharField(choices=[('True', 'True'), ('False', 'False')], default='False', max_length=6, null=True)),
                ('antivirals', models.CharField(choices=[('True', 'True'), ('False', 'False')], default='False', max_length=6, null=True)),
                ('fatique', models.CharField(choices=[('True', 'True'), ('False', 'False')], default='False', max_length=6, null=True)),
                ...
                ('spleen_pallpable', models.CharField(choices=[('True', 'True'), ('False', 'False')], default='False', max_length=6, null=True)),
