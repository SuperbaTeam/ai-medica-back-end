...
class Hepatitis(models.Model):
    ...
    steriod = models.CharField(max_length=6, choices=STERIOD, default=Steriod2, null=True)
    antivirals = models.CharField(max_length=6, choices=ANTIVIRALS, default=Antivirals2, null=True)
    fatique = models.CharField(max_length=6, choices=FATIQUE, default=Fatique2, null=True)
    ...
    spleen_pallpable = models.CharField(max_length=6, choices=SPLEEN_PALLPABLE, default=Spleen_pallpable2, null=True)
